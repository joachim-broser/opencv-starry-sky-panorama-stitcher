...
"""
Rotation
– In a first run match 21 images to a fisheye.
– In consecutive runs, rotate cameras from 0° to 360° in 45° steps.
...
if "Adjust settings":
    pano.config.input_dir = "img_eisenberg_18h37m_ISO1600_30s"
    pano.config.output_dir = "example_05_demonstrate_rotation"
...
if False:
    ...
    for rot_angle_deg in range(0,360+45,45):
        # Always reset:
        ...
        pano_restored = stitching_detailed_enhanced.StitchingDetailedPipeline.load_state_from_disk(
            ...
            "example_05_demonstrate_rotation/2022-12-30_12h34m05s__fisheye_multiband-042.bin"
        )
        ...
        pano_restored.config.result_filename = f"rot={rot_angle_deg:03d}deg"
