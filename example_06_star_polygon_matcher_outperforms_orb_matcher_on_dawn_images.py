...
"""
On dawn sky images (f/3.5 ISO1600 10s), that are rather blue and contain not so many stars as
full exposed images taken after end of the astronomical dawn (f/3.5 ISO1600 30s),
ORB feature matching fails completely and provides poor matching results.

Star polygon matcher solves this problem!

Check the results in the "2022-12-29_19h23m28s__03_pairwise_matches/comparison_ORB_matching_vs_StarPolygon_matching"
folder. Images have been renamed, so ORB and StarPolygon matching results can be compared directly:
    – 01-horiz-n.jpg__02-horiz-ne.jpg__ORB__omitted__conf=0.24145__num_inliers=12.jpg
    – 01-horiz-n.jpg__02-horiz-ne.jpg__STARS__conf=3.00000__num_inliers=9.jpg

    – 01-horiz-n.jpg__08-horiz-nw.jpg__ORB__omitted__conf=0.55028__num_inliers=29.jpg
    – 01-horiz-n.jpg__08-horiz-nw.jpg__STARS__conf=3.00000__num_inliers=15.jpg

    – 01-horiz-n.jpg__09-alt1-n.jpg__ORB__omitted__conf=0.12308__num_inliers=8.jpg
    – 01-horiz-n.jpg__09-alt1-n.jpg__STARS__conf=3.00000__num_inliers=12.jpg
...
if "Adjust settings":
    pano.config.input_dir = "img_eisenberg_18h06m_ISO1600_10s"
    pano.config.output_dir = "example_06_star_polygon_matcher_outperforms_orb_matcher_on_dawn_images"
