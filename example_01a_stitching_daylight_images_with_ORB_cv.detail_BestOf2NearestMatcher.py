...
- Finding matches with cv.detail_BestOf2NearestMatcher
- pano.config.match_conf stays at 0.3
- pano.config.conf_thresh must be decreased to 0.6
"""
...
if "Adjust settings":
    ...
    pano.config.result_filename = "cv.detail_BestOf2NearestMatcher"
    ...
    pano.config.focal_length_pinhole = -1
